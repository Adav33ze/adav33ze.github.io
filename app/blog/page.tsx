...
export const metadata = {
  title: 'Journal — adav33ze',
  description: 'Notes on architecture, climate-responsive design, and the built environment from adav33ze studio.',
}
  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-black selection:text-white">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 py-8 md:px-12 mix-blend-difference">
        <Link href="/" className="text-xs uppercase tracking-widest text-white hover:opacity-50 transition-opacity">
          ← Studio Index
        </Link>
        <span className="text-xs uppercase tracking-widest text-white opacity-50">Journal</span>
      </nav>

      {/* HEADER */}
      <header className="pt-40 pb-16 px-6 md:px-12 border-b border-zinc-200">
        <div className="max-w-7xl mx-auto">
          <p className="text-xs uppercase tracking-widest text-zinc-400 mb-4">03 / Journal</p>
      ...
      <footer className="bg-black text-zinc-500 text-[10px] uppercase tracking-widest py-8 px-6 md:px-12 flex justify-between items-center mt-24">
        ...
        <Link href="/" className="hover:text-white transition-colors">Return to Studio</Link>
      </footer>
